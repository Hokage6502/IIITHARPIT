...
export default function UploadPage() {
  ...
  const upload = () => {
    if (updateState == 0) {
      ...
      const url = 'http://localhost:4000/datasets/upload';
      axios.post(url, body)
      ...
      console.log("TEst")
      const url = 'http://localhost:4000/datasets/upload/' + id.toString();
      axios.post(url, body)
      .then(res => console.log(res));
      console.log(body);
      if (files.length > 0)
      ...
      console.log(body);
      const url = 'http://localhost:4000/datasets/edit/' + DatasetID.toString();
      axios.post(url, body)
      .then(res => console.log(res));
      ...
      console.log(body)
      console.log(params)
      const url = 'http://localhost:4000/datasets/version?'+params.toString();
      console.log(url)
      axios.post(url, body)
      .then(res => console.log(res));
      if (files.length > 0)
